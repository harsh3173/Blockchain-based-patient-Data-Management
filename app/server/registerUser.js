...
exports.enrollRegisterUser = async function(hospitalId, userId, attributes) {
  try {
    ...
    if (hospitalId === 1) {
      ...
      caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp1.coep.com');
      ...
      // build an instance of the fabric ca services client based on
      // the information in the network configuration
      caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp2.coep.com');
      ...
      // build an instance of the fabric ca services client based on
      // the information in the network configuration
      caClient = buildCAClient(FabricCAServices, ccp, 'ca.hosp3.coep.com');
